...
namespace StokTakip.Migrations
{
    ...
    [Migration("20230604084100_Versiyon.1.1")]
    partial class Versiyon11
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StokTakip.Model.UrunDetayi", b =>
                {
                    ...
                    b.Property<int>("AktifMusteriMusteriID")
                        .HasColumnType("int");

                    b.Property<int>("AktifUrunID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AktifMusteriMusteriID");

                    b.HasIndex("AktifUrunID");
            ...
            modelBuilder.Entity("StokTakip.Model.UrunDetayi", b =>
                {
                    b.HasOne("StokTakip.Model.Musteri", "AktifMusteriMusteri")
                        .WithMany("UrunDetayList")
                        .HasForeignKey("AktifMusteriMusteriID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StokTakip.Model.Urun", "AktifUrun")
                        .WithMany("UrunDetayList")
                        .HasForeignKey("AktifUrunID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AktifMusteriMusteri");
